...
# Example usage
main_directory = "hw9\CSCI6963_HW9\Custom_Data_Set"  # Replace with the path to your main directory
output_directory = "hw9\CSCI6963_HW9\Custom_Data_Set\Resized"  # Replace with the path to your output directory
csv_file_path = "hw9\CSCI6963_HW9\Custom_Data_Set\Resized\Custom_Data_Set_Labels.csv"  # Replace with your desired CSV file path
